<?php echo $content['advertise_content']; ?>
		<div class="wrapper">
			<form method="post" action="<?php echo base_url('Advertise/add/'); ?>">
			<div class="form">
                            <?php 
                            ...
                            <?php } ?>
				<h2>Get Started<span>* All fields are required.</span></h2>
				<div class="cf">
				...
				<input type="submit" value="Send Message" class="send-message" name="advertise_submit">
