...
'.$msg[1].'!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Channel</p>
        <a href="<?php echo base_url()."backend/channel/add"; ?>" class="button icon-add">Add New Channel</a>
    </div>
    ...
    <?php echo form_open(base_url( 'backend/channel/save_seo_data' ), array( 'method' => 'POST' ));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo base_url('backend/channel/channel_list') ?>",
                "dataType": "json",
                "type": "POST",
