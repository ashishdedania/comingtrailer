...
'.$msg[1].'!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Actor</p>
        <a href="<?php echo base_url()."backend/actor/add"; ?>" class="button icon-add">Add New Actor</a>
    </div>
    ...
    <?php echo form_open(base_url( 'backend/actor/save_seo_data' ), array( 'method' => 'POST' ));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo base_url('backend/actor/actor_list') ?>",
                "dataType": "json",
                "type": "POST",
