<ul class="language-nav-tabs">
    ...
    <li><a href="#" class="active">Payout</a></li>
...
<script type="text/javascript">
    ...
    function format(d) {
        ...
        var table = '<table cellpadding="5" cellspacing="0" border="0" style="margin:0;width: 50%;float: left;">' +
                '<tr>' +
                '<td><strong>WITHDRAW : </strong>(Point ' + d.point + ') (Rs.' + d.rupees + ') ' + d.withdraw_req_date + '</td>' +
                '</tr>' +
                '<tr>' +
    ...
    $(document).ready(function () {
        ...
        table = $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('backend/user/user_withdraw_payout_list') ?>",
                "dataType": "json",
                "type": "POST",
