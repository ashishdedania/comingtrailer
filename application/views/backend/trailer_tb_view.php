...
' . $msg[1] . '!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Trailer</p>
        <a href="<?php echo base_url() . "backend/trailer/add"; ?>" class="button icon-add">Add New Trailer</a>
    </div>
    ...
    <?php echo form_open(base_url('backend/trailer/save_seo_data'), array('method' => 'POST')); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('backend/trailer/trailer_list') ?>",
                "dataType": "json",
                "type": "POST",
