...
'.$msg[1].'!
    ...
    <div class="content-page">
        <div class="seo-bar">
            ...
            <div class="open-info">
                <?php echo form_open(base_url( 'backend/about/save' ), array( 'method' => 'POST' ));?>
                <div class="input-wrap">
                    <label>Content</label>
                    <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                    <div class="cf"><textarea class="input-field full-field" id="txtEditor" name="content" style="height:300px" required=""><?php echo $data['about_us_content']; ?></textarea></div>
                </div>
    ...
    <?php echo form_open(base_url( 'backend/about/save_seo_data' ), array( 'method' => 'POST' ));?>
