...
'.$msg[1].'!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Director</p>
        <a href="<?php echo base_url()."backend/director/add"; ?>" class="button icon-add">Add New Director</a>
    </div>
    ...
    <?php echo form_open(base_url( 'backend/director/save_seo_data' ), array( 'method' => 'POST' ));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo base_url('backend/director/director_list') ?>",
                "dataType": "json",
                "type": "POST",
