...
'.$msg[1].'!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Music Director</p>
        <a href="<?php echo base_url()."backend/music_director/add"; ?>" class="button icon-add">Add New Music Director</a>
    </div>
    ...
    <?php echo form_open(base_url( 'backend/music_director/save_seo_data' ), array( 'method' => 'POST' ));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo base_url('backend/music_director/music_director_list') ?>",
                "dataType": "json",
                "type": "POST",
