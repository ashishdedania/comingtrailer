...
'.$msg[1].'!
    ...
    <div class="addcategory-total cf">
        <p  class="total-number"><span id="total_number"></span> Personality</p>
        <a href="<?php echo base_url()."backend/personality/add"; ?>" class="button icon-add">Add New Personality</a>
    </div>
    ...
    <?php echo form_open(base_url( 'backend/personality/save_seo_data' ), array( 'method' => 'POST' ));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var data = {'occupation' : '<?php echo (isset($occupation)) ? $occupation : 'actor'; ?>'};
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,            
            "ajax":{
                "url": "<?php echo base_url('backend/personality/personality_list') ?>",
                "dataType": "json",
                "type": "POST",
            ...
            "columns": [
                ...
                { "data": "video" },
                { "data": "trailer" },
               // { "data": "poster","visible": ('<?php echo (isset($occupation)) ? $occupation : 'actor'; ?>' == 'singer' || '<?php echo (isset($occupation)) ? $occupation : 'actor'; ?>' == 'director') ? false : true },
                { "data": "poster"},
                { "data": "action" }
            ],
            "order": [[1, 'desc']]
