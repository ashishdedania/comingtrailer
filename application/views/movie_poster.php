    ...
    <div class="wrapper-full-content">
        <div class="top-wrap">
            <ul class="language-tab">
                ...
                <li><a href="<?php echo base_url('movieposter'); ?>" class="<?php
                    if ($subcat_id == 0) {
                        echo 'active';
                    }
                    ?>">All</a></li>
                    ...
                    foreach ($cat as $value) {
                        ?>
                    <li><a href="<?php echo base_url('movieposter/' . strtolower($value['sub_name'])); ?>" class="<?php
                                    ...
                                    foreach ($trailer->poster_img as $img) {
                                        ...
                                        <a href="<?php echo $seo_urls; ?>">
                                            ...
                                            if (@getimagesize($filename)) {
                                                ?>
                                                <img src="<?php echo $img->poster_img ?>" alt="<?php echo $trailer->poster_name; ?>" /></a>
                                        <?php } else {
                                            ?>
                                            <img src="<?php
                                            echo base_url('resources/images/no-image.svg');
                                            ;
                                            ?>" alt="<?php echo $trailer->poster_name; ?>" /></a>
                                             <?php }
                                             ?>    
                                             <?php
                                             break;
...
$(window).scroll(function() {
           var nearToBottom = 200;
            ...
            if ($(window).scrollTop() + $(window).height() >= ($('#video_trail').offset().top + $('#video_trail').height() - nearToBottom) ) { 
