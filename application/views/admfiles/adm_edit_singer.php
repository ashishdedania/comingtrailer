<div id="ctwpcontent">
	<div class="ctbody-content">
            <div class="view-outerbox cf">
                <?php
                    echo $total_mstp['m'].' Movies '.$total_mstp['t'].' Trailers '.$total_mstp['s'].' Songs ';
                ?>
            ...
            <form action="<?php echo ''. base_url();?>AdmAddSinger/add/<?php echo ''.$actors['id'];?>" method="post" enctype="multipart/form-data">
		<div class="user-profile cf">
			<div class="image-name">
                            <?php 
                    $filename = base_url('images/singers/'.$actors['singer_img']);
                        if(@getimagesize($filename)) {
                        ?>
                            <img src="<?php echo base_url().'images/singers/'.$actors['singer_img'];?>"  alt="" id="img" />
                             <?php
                        }else{
                        ?>
...
<!--					<input type="submit" class="button delete" value="delete">-->
			...
			<div class="info-block">
				...
				<label>Name</label>
                                <div class="cf"><input type="text" name="actor" value="<?php echo ''.$actors['singer_name'];?>" required class="input-field"></div>
				</div>
				<div class="input-wrap">
				<label>Title</label>
                                <div class="cf"><input type="text" name="title" value="<?php echo ''.$actors['singer_title'];?>" class="input-field"></div>
				</div>
				<div class="input-wrap">
					<label>description</label>
                                        <div class="cf"><textarea class="description" name="desc" rows="10" cols="40"><?php echo ''.$actors['singer_desc'];?></textarea></div>
				</div>
				<div class="input-wrap">
					<label>keywords</label>
                                        <div class="cf"><input type="text" name="keywords" value="<?php echo ''.$actors['singer_keywords'];?>" class="input-field"></div>
				</div>
                            <input type="submit" name="submit" class="button" value="Update">
                            
                            <a href="<?php echo ''. base_url();?>AdmAddSinger/deleteStatus/singer/<?php echo ''.$actors['id'];?>/1" class="button delete">delete singer</a>
			</div>
            ...
            <ul class="name-tabs">
                <li><a href="<?php echo base_url('AdmViewSinger/edit/'.$actors['id'].'/m'); ?>" class="<?php echo $mstp == 'm' ? 'active' : ''; ?>">Movie</a></li>
<!--                <li><a href="<?php //echo base_url('AdmViewSinger/edit/'.$actors['id'].'/t'); ?>" class="<?php //echo $mstp == 't' ? 'active' : ''; ?>">Trailer</a></li>-->
                <li><a href="<?php echo base_url('AdmViewSinger/edit/'.$actors['id'].'/s'); ?>" class="<?php echo $mstp == 's' ? 'active' : ''; ?>">Song</a></li>
            </ul>
            <div class="search-bar cf">
                <form onsubmit="return searchTrailer()" method="post" name="search_form" action="<?php echo base_url('AdmViewSinger/edit/'.$actors['id'].'/'.$mstp); ?>">    
            ...
            <div class="ct-movie-lists">
                <ul class="list cf">
                    <?php
                        $controller = array("m"=>"AdmViewMovie/edit/","s"=>"AddVideo/viewTrailer/","t"=>"AddVideo/viewTrailer/");
                        $images_folder = array(
                                            'm'=>'movies',
                                            't'=>'videothumb',
                                            's'=>'videothumb',
                                        );
                        $mstp_img = ['m'=>'movie_img','s'=>'video_thumb','t'=>'video_thumb'];
//                        print_r($actors_data);exit;
