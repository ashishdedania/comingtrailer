<div id="ctwpcontent">
	<ul class="language-nav-tabs">
		<li><a href="<?php echo base_url('AdmContactUs'); ?>" class="active">Contact Us</a></li>
		<li><a href="<?php echo base_url('AdmContactFormData'); ?>">Form Data</a></li>
	</ul>
	...
	<div class="ctbody-content">
		...
		<div class="content-page">
			...
			<div class="seo-bar">
				...
				<div class="open-info">
					<form method="post" action="<?php echo base_url('AdmContactUs/add') ?>">
						<div class="input-wrap">
							<label>Content</label>
							<div class="cf"><textarea class="input-field full-field" id="txtEditor" name="content" style="height:300px" required><?php echo $content['contact_us_content']; ?></textarea></div>
						</div>
