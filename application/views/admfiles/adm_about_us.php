<div id="ctwpcontent">
	<ul class="language-nav-tabs">
		<li><a href="<?php echo base_url('AdmAboutUs'); ?>" class="active">About Us</a></li>
	</ul>
	...
	<div class="ctbody-content">
		...
		<div class="content-page">
			...
			<div class="seo-bar">
				...
				<div class="open-info">
					<form method="post" action="<?php echo base_url('AdmAboutUs/add'); ?>">
						<div class="input-wrap">
							<label>Content</label>
							<div class="cf"><textarea class="input-field full-field" id="txtEditor" style="height:300px;" name="content"><?php echo $content['about_us_content']; ?></textarea></div>
						</div>
