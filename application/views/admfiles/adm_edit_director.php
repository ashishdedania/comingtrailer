<div id="ctwpcontent">
	<div class="ctbody-content">
            ...
            <form action="<?php echo ''. base_url();?>AdmAddDirector/add/<?php echo ''.$actors['id'];?>" method="post" enctype="multipart/form-data">
		<div class="user-profile cf">
			<div class="image-name">
                            <?php 
                    $filename = base_url('images/directors/'.$actors['director_img']);
                        if(@getimagesize($filename)) {
                        ?>
                            <img src="<?php echo base_url().'images/directors/'.$actors['director_img'];?>"  alt="" id="img" />
                            <?php
                        }else{
                        ?>
...
<!--					<input type="submit" class="button delete" value="delete">-->
			...
			<div class="info-block">
				...
				<label>Name</label>
                                <div class="cf"><input type="text" name="actor" value="<?php echo ''.$actors['director_name'];?>" required class="input-field"></div>
				</div>
				<div class="input-wrap">
				<label>Title</label>
                                <div class="cf"><input type="text" name="title" value="<?php echo ''.$actors['director_title'];?>" class="input-field"></div>
				</div>
				<div class="input-wrap">
					<label>description</label>
                                        <div class="cf"><textarea class="description" name="desc" rows="10" cols="40"><?php echo ''.$actors['director_desc'];?></textarea></div>
				</div>
				<div class="input-wrap">
					<label>keywords</label>
                                        <div class="cf"><input type="text" name="keywords" value="<?php echo ''.$actors['director_keywords'];?>" class="input-field"></div>
				</div>
                            <input type="submit" name="submit" class="button" value="Update">
                            <a href="<?php echo ''. base_url();?>AdmAddDirector/deleteStatus/director/<?php echo ''.$actors['id'];?>/1" class="button delete">delete director</a>
			</div>
            ...
            <ul class="name-tabs">
                <li><a href="<?php echo base_url('AdmViewDirector/edit/'.$actors['id'].'/m'); ?>" class="<?php echo $mstp == 'm' ? 'active' : ''; ?>">Movie</a></li>
                <li><a href="<?php echo base_url('AdmViewDirector/edit/'.$actors['id'].'/t'); ?>" class="<?php echo $mstp == 't' ? 'active' : ''; ?>">Trailer</a></li>
                <li><a href="<?php echo base_url('AdmViewDirector/edit/'.$actors['id'].'/s'); ?>" class="<?php echo $mstp == 's' ? 'active' : ''; ?>">Song</a></li>
                <li><a href="<?php echo base_url('AdmViewDirector/edit/'.$actors['id'].'/p'); ?>" class="<?php echo $mstp == 'p' ? 'active' : ''; ?>">poster</a></li>
            </ul>
            <div class="search-bar cf">
                <form onsubmit="return searchTrailer()" method="post" name="search_form" action="<?php echo base_url('AdmViewDirector/edit/'.$actors['id'].'/'.$mstp); ?>">    
            ...
            <div class="ct-movie-lists">
                <ul class="list cf">
                    <?php
                        ...
                        if(@getimagesize($filename)) {
                               ?>
                                    <img src="<?php echo base_url('images/'.$images_folder[$mstp].'/'.$val->$mstp_img[$mstp]); ?>" alt="No Img">
                                    <?php }else{
                            ...
                            foreach($actors_data as $key => $val){
                                ...
                                ?>   
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url('AddPoster/editPoster/'.$v->poster_id); ?>"><?php echo $v->poster_name; ?></a></td>
                                        <td>
                                            <?php
                                                $movie_data = '';
