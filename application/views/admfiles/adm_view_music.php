<div id="ctwpcontent">
    ...
    <li><a href="<?php echo base_url('AdmViewMusic');?>" class="<?php if($is_delete == 'no'){ echo 'active';}?>">All</a></li>
			...
			<p class="total-number">
                             <?php 
                                        foreach ($actors as $value) {
                                            echo ''.$value['count'];?> Music
                        <?php
                        break;
                                        }
                                    ?>
                        </p>
                        <a href="<?php echo base_url();?>AdmAddMusic" class="button icon-add">Add New Music</a>
		</div>
    <div class="search-bar cf">
        <form method="post" name="seo_form" action="<?php echo base_url('AdmViewMusic'); ?>">    
                        ...
                        <input type="text" id="search" name="search_keyword" placeholder="Search Keywords" value="<?php echo $this->input->post('search_keyword') ? $this->input->post('search_keyword') : ''?>" class="input-search">
			...
			<div>
				<ul class="list">
                                    ...
                                    <li>
                                        <?php if($is_delete == 'no'){
                                            ?>
                                        <a href="<?php echo base_url();?>AdmViewMusic/edit/<?php echo ''.$value['music_id'];?>" name="names"><?php echo ''.$value['music_name'];?></a>
                                        <?php
                                        }else{
                                            
                                            ?>
                                        <a href="<?php echo base_url();?>AdmViewMusic/edit/music/<?php echo ''.$value['music_id'];?>" name="names"><?php echo ''.$value['music_name'];?></a>
                                        <div class="restore-delete">
                                            <a href="<?php echo base_url();?>AdmAddMusic/deleteStatus/music/<?php echo ''.$value['music_id'];?>/0" class="icon-restore" onclick="return confirm('Are you sure to reactive this music?')"></a>
                                            <a href="<?php echo base_url('AdmAddMusic/delete/music/'.$value['music_id'].'/'.$value['seo_url_id']); ?>" class="icon-delete" onclick="return confirm('Are you sure to parmenatlly delete this music?')"></a>
                                        </div>
                                        <?php
                                        }
                                        }
