<div id="ctwpcontent">
	<ul class="language-nav-tabs">
		<li><a href="<?php echo base_url('AdmPartnership'); ?>">Partnership</a></li>
		<li><a href="<?php echo base_url('AdmPartnershipFormData'); ?>" class="active">Form Data</a></li>
	</ul>
	...
	<div class="ctbody-content">
		...
		<div class="search-bar cf">
                ...
                <form method="post" name="seo_form" action="<?php echo base_url('AdmPartnershipFormData'); ?>">    
        ...
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody id="trailer-data">
				...
				<li class="col6"><a href="#">Company<span class="icon-arrow-drop-down"></span></a></li>
				<li class="col7"><a href="#">City<span class="icon-arrow-drop-down"></span></a></li>
				<li class="col8"><a href="#">Country<span class="icon-arrow-drop-down"></span></a></li>
				<li class="col9"><a href="#">Message<span class="icon-arrow-drop-down"></span></a></li>
				<li class="col10"><a href="#">action</a></li>
			</ul>
			<?php
//			if(	!empty( $content ) ) {
//				$srno = 1;
...
//						echo '<li class="col6">'. $contact['company'] .'</li>';
//						echo '<li class="col7">'. $contact['city'] .'</li>';
//						echo '<li class="col8">'. $contact['country'] .'</li>';
//						echo '<li class="col9">'. $contact['message'] .'</li>';
//						echo '<li class="col10"><a href="#" class="icon-edit"></a> <a href="#" class="icon-view"></a> <a href="#" class="icon-arrow-drop-down"></a></li>';
//					echo '</ul>';
//				}
//			} else {
//				echo '<ul class="info-list cf">';
