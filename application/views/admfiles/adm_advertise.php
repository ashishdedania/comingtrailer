<div id="ctwpcontent">
	<ul class="language-nav-tabs">
		<li><a href="<?php echo base_url('AdmAdvertise'); ?>" class="active">Advertise</a></li>
		<li><a href="<?php echo base_url('AdmAdvertiseFormData'); ?>">Form Data</a></li>
	</ul>
	...
	<div class="ctbody-content">
		...
		<div class="content-page">
			...
			<div class="seo-bar">
				...
				<div class="open-info">
					<form method="post" action="<?php echo base_url('AdmAdvertise/add'); ?>">
						<div class="input-wrap">
							<label>Content</label>
							<div class="cf"><textarea class="input-field full-field" style="height:300px;" id="txtEditor" name="content"><?php echo $content['advertise_content']; ?></textarea></div>
						</div>
