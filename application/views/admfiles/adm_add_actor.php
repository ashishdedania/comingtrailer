<div id="ctwpcontent">
	<div class="ctbody-content">
            ...
            <form onsubmit="return validateImage();" action="AdmAddActor/addActor" method="post" enctype="multipart/form-data">
		<div class="user-profile cf">
			<div class="image-name">
                            <img src="http://odedara.com/comingtrailer/resources/images/no-user.svg"  alt="" id="img" />
