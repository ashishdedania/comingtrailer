<div id="ctwpcontent">
    ...
    <li><a href="<?php echo base_url('AdmViewSinger');?>" class="<?php if($is_delete == 'no'){ echo 'active';}?>">All</a></li>
        
    <li><a href="<?php echo base_url($this->router->fetch_class());?>/deleted/singer" class="<?php if($is_delete == 'yes'){ echo 'active';}?>">DELETE</a></li>    
</ul>
			...
			<p class="total-number">
                             <?php 
                                        foreach ($actors as $value) {
                                            echo ''.$value['count'];?> Singer
                        <?php
                        break;
                                        }
                                    ?>
                        </p>
                        <a href="<?php echo base_url();?>AdmAddSinger" class="button icon-add">Add New Singer</a>
		</div>
    <div class="search-bar cf">
			
        <form method="post" name="seo_form" action="<?php echo base_url('AdmViewSinger'); ?>">    
			...
			<div>
				<ul class="list">
                                    ...
                                    <li>
                                        ...
                                        if($is_delete == 'no'){
                                        ?>
                                        <a href="<?php echo base_url();?>AdmViewSinger/edit/<?php echo ''.$value['singer_id'];?>" name="names"><?php echo ''.$value['singer_name'];?>
                                        </a>
                                        <?php }else{
                                            ?>
                                        <a href="<?php echo base_url();?>AdmViewSinger/edit/<?php echo ''.$value['singer_id'];?>" name="names"><?php echo ''.$value['singer_name'];?>
                                        ...
                                        <div class="restore-delete">
                                            <a href="<?php echo base_url();?>AdmAddSinger/deleteStatus/singer/<?php echo ''.$value['singer_id'];?>/0" class="icon-restore" onclick="return confirm('Are you sure to reactive this singer?')"></a>
                                            <a href="<?php echo base_url('AdmAddSinger/delete/singer/'.$value['singer_id'].'/'.$value['seo_url_id']); ?>" class="icon-delete" onclick="return confirm('Are you sure to parmenatlly delete this singer?')"></a>
                                        </div>
                                        <?php
                                        }
                                        }
