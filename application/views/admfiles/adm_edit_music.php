<div id="ctwpcontent">
	<div class="ctbody-content">
            ...
            <form action="<?php echo ''. base_url();?>AdmAddMusic/add/<?php echo ''.$actors['id'];?>" method="post" enctype="multipart/form-data">
		<div class="user-profile cf">
			<div class="image-name">
                             <?php 
                    $filename = base_url('images/music/'.$actors['music_img']);
                        if(@getimagesize($filename)) {
                        ?>
                            <img src="<?php echo base_url().'images/music/'.$actors['music_img'];?>"  alt="" id="img" />
                            <?php
                        }else{
                        ?>
			...
			<div class="info-block">
				...
				<label>Name</label>
                                <div class="cf"><input type="text" name="actor" value="<?php echo ''.$actors['music_name'];?>" required class="input-field"></div>
				</div>
				<div class="input-wrap">
				<label>Title</label>
                                <div class="cf"><input type="text" name="title" value="<?php echo ''.$actors['music_title'];?>" class="input-field"></div>
				</div>
				<div class="input-wrap">
					<label>description</label>
                                        <div class="cf"><textarea class="description" name="desc" rows="10" cols="40"><?php echo ''.$actors['music_desc'];?></textarea></div>
				</div>
				<div class="input-wrap">
					<label>keywords</label>
                                        <div class="cf"><input type="text" name="keywords" value="<?php echo ''.$actors['music_keywords'];?>" class="input-field"></div>
				</div>
                            <input type="submit" name="submit" class="button" value="Update">
                             <a href="<?php echo ''. base_url();?>AdmAddMusic/deleteStatus/music/<?php echo ''.$actors['id'];?>/1" class="button delete">delete music</a>
			</div>
		</div>
                
            </form>
            <ul class="name-tabs">
                <li><a href="<?php echo base_url('AdmViewMusic/edit/'.$actors['id'].'/m'); ?>" class="<?php echo $mstp == 'm' ? 'active' : ''; ?>">Movie</a></li>
                <li><a href="<?php echo base_url('AdmViewMusic/edit/'.$actors['id'].'/t'); ?>" class="<?php echo $mstp == 't' ? 'active' : ''; ?>">Trailer</a></li>
                <li><a href="<?php echo base_url('AdmViewMusic/edit/'.$actors['id'].'/s'); ?>" class="<?php echo $mstp == 's' ? 'active' : ''; ?>">Song</a></li>
            </ul>
            <div class="search-bar cf">
                <form onsubmit="return searchTrailer()" method="post" name="search_form" action="<?php echo base_url('AdmViewMusic/edit/'.$actors['id'].'/'.$mstp); ?>">    
