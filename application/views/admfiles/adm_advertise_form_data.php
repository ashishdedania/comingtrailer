<div id="ctwpcontent">
	<ul class="language-nav-tabs">
		<li><a href="<?php echo base_url('AdmAdvertise'); ?>">Contact Us</a></li>
		<li><a href="<?php echo base_url('AdmAdvertiseFormData'); ?>" class="active">Form Data</a></li>
	</ul>
	...
	<div class="ctbody-content">
		...
		<div class="search-bar cf">
                ...
                <form method="post" name="seo_form" action="<?php echo base_url('AdmAdvertiseFormData'); ?>">    
